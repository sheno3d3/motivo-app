      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(
          ...
          child: Column(children: [
            Row(
              ...
              children: [
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('SUNDAY, 1 JUNE 2025', style: AppTextStyles.label()),
            ...
            Row(children: [
              Expanded(child: MiniStatBox(value: '${stats.km}', label: 'km',
                icon: Icons.straighten, iconColor: AppColors.orange)),
              const SizedBox(width: 7),
              Expanded(child: MiniStatBox(value: '${stats.calories}', label: 'kcal',
                icon: Icons.favorite_border, iconColor: AppColors.rose)),
              const SizedBox(width: 7),
              Expanded(child: MiniStatBox(value: '${stats.activeMinutes}', label: 'min',
                icon: Icons.schedule_outlined, iconColor: AppColors.blue)),
              const SizedBox(width: 7),
              Expanded(child: MiniStatBox(value: '${user.streakDays}🔥', label: 'streak',
        ...
        SectionHeader(
          title: 'Active Missions', actionLabel: 'View all',
        ...
        SectionHeader(
          title: 'Hot Offers 🔥', actionLabel: 'See all',
          onAction: () => Navigator.push(context,
            MaterialPageRoute(builder: (_) => const RewardsScreen())),
        ),
        SizedBox(
...
class _BellButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GlassCard(
      borderRadius: 13, padding: const EdgeInsets.all(10),
        ...
        child: Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(reward.category.name.toUpperCase(), style: AppTextStyles.label()),
    ...
    return Container(
      ...
      child: SingleChildScrollView(child: Column(
        ...
        children: [
          ...
          Text(mission.title, style: AppTextStyles.display(size: 22, weight: FontWeight.w700)),
          const SizedBox(height: 7),
          ...
          MotivProgressBar(progress: mission.progress,
            colors: [mission.typeColor, mission.typeColor.withOpacity(.7)], height: 5),
          const SizedBox(height: 20),
          SizedBox(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: AppColors.orange.withOpacity(.28),
          ...
          SizedBox(width: double.infinity, child: TextButton(
            ...
            child: Text('Maybe later', style: AppTextStyles.body(
              size: 12.5, weight: FontWeight.w500, color: AppColors.text2)),
          )),
        ],
      )),
    );
          ...
          Container(
            ...
            child: Row(children: [
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const SizedBox(height: 4),
                Text('${reward.coinCost} ⬡', style: AppTextStyles.display(
                  size: 26, weight: FontWeight.w900, color: AppColors.orange)),
              ]),
              const Spacer(),
              Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                Text('YOUR BALANCE', style: AppTextStyles.label()),
                const SizedBox(height: 4),
                Text('$userCoins ⬡', style: AppTextStyles.display(
                  size: 26, weight: FontWeight.w900, color: AppColors.green)),
              ]),
            ]),
          ),
          const SizedBox(height: 18),
          SizedBox(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                alignment: Alignment.center,
                child: Text('Redeem Now', style: AppTextStyles.button().copyWith(
