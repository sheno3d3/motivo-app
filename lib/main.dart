  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: BackdropFilter(
        filter: import_dart_ui.ImageFilter.blur(sigmaX: 48, sigmaY: 48),
        child: Container(
          ...
          padding: EdgeInsets.fromLTRB(6, 0, 6, MediaQuery.of(context).padding.bottom + 10),
          child: Row(
...
// dart:ui alias since we can't import inside string
